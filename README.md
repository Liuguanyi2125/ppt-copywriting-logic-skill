...
```text
页面任务 -> 信息颗粒 -> 信息关系 -> 信息可视化路线 -> 页面级结论 -> 页面语言压缩 -> PPT 文案层级 -> 结构化检查 -> 页面结构 -> 可选 AI 视觉提示词
```
...
```text
进入设计前，先确认页面任务单一、标题有结论、层级已分明、要点已提炼、关键事实保留、关系可被看见。
结构化检查不通过，就返回前面的标题、压缩或文案层级阶段返工，不继续美化。
```

信息可视化路线：

```text
场景可视化：抽象概念 / 专业名词 / 产品特性 / 情绪感受 / 应用场景
逻辑可视化：并列 / 递进 / 因果 / 流程 / 系统构成 / 问题拆解
数据可视化：数字 / 趋势 / 占比 / 排名 / 金额 / 参数对比
```
...
- 判断一页内容应该走场景可视化、逻辑可视化，还是数据可视化。
- 在进入设计环节前检查内容是否已分层级、提炼要点、保留关键事实。
...
- 信息颗粒
- 逻辑关系
- 信息可视化路线：主路线、辅助路线、判断理由、视觉转译
- 页面级标题
- 语言压缩：原句、短句、标签
- PPT 文案层级
- 页面可见文案：一级标签、二级短语、必要数字
- 演讲稿备注
- 结构化检查：是否可进入设计环节、需要返工什么
- 页面结构建议
- 可以删掉的信息
- 下一步动作
